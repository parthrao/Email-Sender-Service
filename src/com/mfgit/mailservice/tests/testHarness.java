...
public class testHarness {
	...
	public void test_1()
	{
		...
		+ "In case of any issues / queries please email to - <a href='mit.appsupportdesk@maximintegrated.com'>MIT.AppSupportDesk@maximintegrated.com</a><br><br>"
		+ "- | Maxim Integrated | GNR | </html>");
		sm.setSubject("EMPTY or NO File Found | ASE-CL | FY16Q4WW50");
		sm.addAddress("Nitin.Dodia@maximintegrated.com");
		fc.sendRequest(sm);
	}
	...
	public void test_2()
	{
		...
		mc.simpleSend("kkhushali.dave@gmail.com", "singleton Test", "This is the reminder to provide the file");
	}
